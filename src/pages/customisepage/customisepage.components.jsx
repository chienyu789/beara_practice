...
const CustomisePage = () => (
  <div>
    ...
    <div className="customise-detail">
      <p>Embossings can add a lot of personality to a bag. Whether it's for yourself or as a lovely gift, adding a personal touch is a fantastic option.</p>
      <p>We charge a flat rate of £15. Depending on 1) the font type, 2) the position and 3) the type of bag, you can emboss up to 14 characters. Times New Roman font can fit up to 7 capitals and Handwritten font is slightly smaller so can fit up to 8 capital letters.</p>
      <p>Symbols are generally the same size as upper case letters and can only be used along with Times New Roman letters. The quantity of letters and symbols you can use will show automatically when inputting your embossing details on the product page.</p>
      <p>Please note that our embossings are now case sensitive so if you type capital or lower case letters when placing your order this is what you will receive on your bag.</p>
    </div>
